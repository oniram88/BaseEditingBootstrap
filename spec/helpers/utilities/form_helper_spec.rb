  ...
  describe "#form_print_field" do
    ...
    context "post model" do
      ...
      context "editable" do
        it "with base rendering" do
          expect(helper.form_print_field(form, :title, readonly: false)).to have_tag(:input, with: {class: "form-control", type: "text", name: "post[title]"})
        end

        it "with timestamps rendering" do
          expect(helper.form_print_field(form, :created_at, readonly: false)).to have_tag(:input, with: {class: "form-control", type: "datetime-local", name: "post[created_at]"})
        end

        it "with specific rendering" do
          expect(helper.form_print_field(form, :description, readonly: false)).to have_tag(:textarea, with: {class: "form-control", name: "post[description]"})
        end

        it "decimal_test_number" do
          expect(helper.form_print_field(form, :decimal_test_number, readonly: false)).to have_tag(:input, with: {type: "number", step: "0.001"})
        end
        it "rating" do
          expect(helper.form_print_field(form, :rating, readonly: false)).to have_tag(:input, with: {type: "number", step: "0.01"})
        end
        it "published_at" do
          expect(helper.form_print_field(form, :published_at, readonly: false)).to have_tag(:input, with: {type: "date"})
        end
        it "read_counter" do
          expect(helper.form_print_field(form, :read_counter, readonly: false)).to have_tag(:input, with: {type: "number", step: "1"})
        end
        describe "belongs_to" do
          ...
          it do
            expect(helper.form_print_field(form, :user, readonly: false)).to have_tag(:select, with: {name: "post[user_id]"}) do
        ...
        describe "enum" do
          it "as string enum" do
            expect(helper.form_print_field(form, :category, readonly: false)).to have_tag(:select) do
              with_tag(:option, text: "News", with: {value: "news"})
            end
          end
          it "as integer" do
            expect(helper.form_print_field(form, :priority, readonly: false)).to have_tag(:select) do
        ...
        describe "has_one_attached" do
          ...
          subject { helper.form_print_field(form, :primary_image, readonly: false) }
      ...
      context "readonly" do
        ...
        it "with specific rendering" do
          expect(helper.form_print_field(form, :description, readonly: true)).to have_tag(:textarea, with: {class: "form-control custom-readonly", name: "post[description]", readonly: "readonly"})
        end
        ...
        describe "has_one_attached" do
          ...
          subject { helper.form_print_field(form, :primary_image, readonly: true) }
    ...
    context "red_post with custom form helper" do
      ...
      it "title overridden" do
        expect(helper.form_print_field(form, :title, readonly: false)).to have_tag(:textarea, with: {class: "form-control", name: "red_post[title]"})
      end
    ...
    context "user model" do
      ...
      it "with override base" do
        expect(helper.form_print_field(form, :username, readonly: false)).to have_tag(:input, with: {class: "form-control override", type: "text", name: "user[username]"})
      end

      it "with default boolean" do
        expect(helper.form_print_field(form, :enabled, readonly: false)).to have_tag(".form-check.form-switch") do
      ...
      it "with override timestamp" do
        expect(helper.form_print_field(form, :created_at, readonly: false)).to have_tag(:input, with: {class: "form-control", type: "datetime-local", name: "user[created_at]"})
      end
    ...
    context "comment model" do
      ...
      it "textarea" do
        expect(helper.form_print_field(form, :comment, readonly: false)).to have_tag(:textarea,
                                                                                     with: {
                                                                                       class: "form-control",
    ...
    context "ActiveModel" do
      ...
      it "render standard fields as text" do
        expect(helper.form_print_field(form, :example_field, readonly: false)).to have_tag(:input, with: {class: "form-control", type: "text", name: "nome_classe[example_field]"})
      end
